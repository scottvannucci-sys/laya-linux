...
def _iter_text(state: str | dict | list | None, _depth: int = 0) -> list[str]:
...
def state_text(state: str | dict | list | None, max_chars: int = 4000) -> str:
...
def analyse(state: str | dict | list | None) -> dict[str, object]:
...
def is_english(state: str | dict | list | None) -> bool:
